function [SpikeTrain,median_syllable_starting,median_gap_starting] = MakeTimeWarpedRasterBatch(DirectoryName,FileName,FileExt,FileNos,ChannelString,BinSize,Motif,latency,SpikeSortOrThreshold,FigTitle)
SpikeTimes = [];
SpikeAmplitudes = [];
SpikeWaveforms = [];
