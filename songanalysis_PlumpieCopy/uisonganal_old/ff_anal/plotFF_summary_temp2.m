function plotFF_summary_temp(directory_pre2, directory_post2wk, directory_post8wk, bird, note);
...
X = [-1 14 56]; 
dir_mean = [dir_pre2_mean, dir_post2wk_mean, dir_post8wk_mean];
undir_mean = [undir_pre2_mean, undir_post2wk_mean, undir_post8wk_mean];
dir_sem = [dir_pre2_sem, dir_post2wk_sem, dir_post8wk_sem];
undir_sem = [undir_pre2_sem, undir_post2wk_sem, undir_post8wk_sem];
...
% plot CV of FF
dir_cv = [dir_pre2_cv, dir_post2wk_cv, dir_post8wk_cv];
undir_cv = [undir_pre2_cv, undir_post2wk_cv, undir_post8wk_cv];
...
% plot SD of FF
dir_std = [dir_pre2_std, dir_post2wk_std, dir_post8wk_std];
undir_std = [undir_pre2_std, undir_post2wk_std, undir_post8wk_std];
subplot(2,2,2); 
...
dir_norm_std = [dir_pre2_norm_std, dir_post2wk_norm_std, dir_post8wk_norm_std];
undir_norm_std = [undir_pre2_norm_std, undir_post2wk_norm_std, undir_post8wk_norm_std];
subplot(2,2,4); 
