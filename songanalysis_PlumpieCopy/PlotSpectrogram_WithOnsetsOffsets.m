function [] = PlotSpectrogram_WithOnsetsOffsets(pathname,filename,FileType,ColourMap, varargin)
...
axes('Position',[0.1 0.2 0.85 0.65]);
...
for i = 0:1:floor(t_max),
    plot([i i], [300 700], 'k', 'LineWidth', 2);
end

set(gca, 'YTick', [0:2000:8000], 'YTickLabel', [0:2:8]);
for i = 0:2000:8000,
    plot([t_min (0.005*(t_max - t_min))], [i i], 'k', 'LineWidth', 2);
end

plot([t_min t_min], [300 8000], 'k', 'LineWidth', 2);