function [] = CheckTemplateMatchingParameters(ParameterFile, SyllableTemplateFile, NoteFileDir, Normalization)
...
for SyllTemp = 1:length(Parameters.SyllableTemplate.SyllableTemplates),
    ...
    for i = 1:Parameters.NoPreDays,
        ...
        disp(['      Pre Day #', num2str(i), ' - undirected song ...']); 
        MA_TemplateMatch_WithBoutLens(Parameters.PreDataDir{i}, Parameters.PreUnDirSongFileNames{i}{1}, Parameters.FileType, SyllableTemplate, Label, TemplateMatchOutputDir, TemplateType, Parameters.PreUnDirBoutOnsets{i}{1}, Parameters.PreUnDirBoutOffsets{i}{1}, Normalization);
    end
end
