function [Bout] = MA_RandomTemplateMatch_WithBoutLens(DataDir, SongFile, FileType, MotifTemplate, Label, OutputDir, TemplateType, BoutOnsets, BoutOffsets, Normalization)
