function [Correlation] = CalculateIFRCorrelation(SpikeTrain, Range, Resolution)
...
disp(['Resolution is ', num2str(Resolution), ' ms and the IFR Correlation = ',num2str(mean(Temp(find(Temp)))), ' +/- ', num2str(std(Temp(find(Temp))))]);
