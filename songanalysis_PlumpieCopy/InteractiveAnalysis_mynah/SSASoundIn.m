function [rawsong, Fs]=SSASoundIn(pathname, RecFileDirectory, soundfile, filetype)
...
elseif  strcmp(filetype(1:3),'obs')
   ...
   [rawsong, Fs]= SSAget_daqdata_copy(RecFileDirectory, [pathname, soundfile],chan_spec);
