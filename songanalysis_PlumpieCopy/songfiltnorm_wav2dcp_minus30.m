...
% This converts a wav file into a dcp file and attenuates the amplitude (-30dB)
...
while 1
  ...
  % Write to file
  if songtype == 2
    normdcpsongfile = [songfile, '-30dB.norm_40k.dcp']
  else
    normdcpsongfile = [songfile, '-30dB.norm.dcp']
  end
