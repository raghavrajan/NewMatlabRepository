...
% Right now this program is used to convert from 32 kHz raw
% byte-swapped observer files to dcp files
...
% Will assume input observer files recorded at this rate!
Fs = 32000
nbits = 16;
...
%  [song,Fs,nbits]=wavread(songfile);
  ...
  % Write to file
  if songtype == 2
    normdcpsongfile = [songfile, '.norm.alx']
  else
