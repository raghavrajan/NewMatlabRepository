...
try
    ...
    for BoutNo = 1:length(BoutOnsets),
        ...
        Bout{BoutNo}.MaxBoutSeqMatchVal = [Bout{BoutNo}.T(MaxInd) MaxVal];
        Bout{BoutNo}.FileName = SongFile;
        Bout{BoutNo}.FileLength = (BoutOffsets(BoutNo) - BoutOnsets(BoutNo))/1000;
        Bout{BoutNo}.BoutOnset = BoutOnsets(BoutNo);
        Bout{BoutNo}.BoutOffset = BoutOffsets(BoutNo);
        Bout{BoutNo}.BoutSeqMatch = [];
    end
catch
