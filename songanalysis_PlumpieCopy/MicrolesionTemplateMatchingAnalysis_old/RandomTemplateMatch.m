function [Bout] = RandomTemplateMatch(DirectoryName, FileList, FileType, MotifTemplate, Label, OutputDir, StatusText, StatusAxis, StatusString, Colour, TemplateType)
...
for SongFileNo = 1:min(25,length(SongFiles)),
