function [WarpedMotifTemplate] = StretchCompressTemplates(RawData, Fs, TimeStretch, FreqStretch, varargin)


if (nargin > 4)
    WinSize = varargin{1}; % in ms
    WinOverlap = varargin{2}; % step size in ms
else
    WinSize = 8; % in ms
