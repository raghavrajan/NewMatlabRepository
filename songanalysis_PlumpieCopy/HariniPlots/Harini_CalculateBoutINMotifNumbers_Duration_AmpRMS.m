function [Bout_Stats] = Harini_CalculateBoutINMotifNumbers_Duration_AmpRMS(IndividualBirds, Bouts, MotifLabels, INLabels, CommonMotifs)
...
for k = Bouts(:)',
    ...
    BoutSAPLogAmp = IndividualBirds.AllSyllableLogAmplitudeRMS(IndividualBirds.Bouts(k,1):IndividualBirds.Bouts(k,2));
