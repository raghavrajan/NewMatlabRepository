function [L0Dir_Undir_PValue] = Harini_FeatureFits_INNum_MotifNumDur_DUNAlso(DirBout_Stats, DirUndirBout_Stats, UndirBout_Stats, Distances, BirdNames)
...
for i = 1:length(DirBout_Stats),
    ...
    print(fullfile(FinalFigureDir, [BirdNames{i}, 'FeatureFits_INNum_MotifNum_MotifDur_DUNAlso.eps']), '-depsc2', '-r600');
    print(fullfile(FinalFigureDir, [BirdNames{i}, 'FeatureFits_INNum_MotifNum_MotifDur_DUNAlso.png']), '-dpng', '-r600');
end
...
set(gcf, 'PaperPositionMode', 'auto');
print(fullfile(FinalFigureDir, ['AllBirds_Summary_INNum_MotifNum_MotifDur_DUNAlso.eps']), '-depsc2', '-r600');
print(fullfile(FinalFigureDir, ['AllBirds_Summary_INNum_MotifNum_MotifDur_DUNAlso.png']), '-dpng', '-r600');
...
set(gcf, 'Position', [10 1.4 8.3 3.1]);
set(gcf, 'PaperPositionMode', 'auto');
print(fullfile(FinalFigureDir, ['AllBirds_Slope_Summary_INNum_MotifNum_MotifDur_DUNAlso.eps']), '-depsc2', '-r600');
print(fullfile(FinalFigureDir, ['AllBirds_Slope_Summary_INNum_MotifNum_MotifDur_DUNAlso.png']), '-dpng', '-r600');
