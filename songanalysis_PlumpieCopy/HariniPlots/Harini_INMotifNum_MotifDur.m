function [DirBout_Stats, UndirBout_Stats, DirUndirBout_Stats] = Harini_INMotifNum_MotifDur(IndividualBirds, BirdNames, BirdOption, FeatureToPlot_ColNo, PlotType, DifferentMicrophones)
...
% First get amplitudes for each of the syllables using the raw waveforms
% while taking into consideration the baseline
% MeanFFTLogAmpValues = Harini_CalcBaselineSubtractedLogAmplitude(IndividualBirds, BirdNames);

% for i = 1:length(MeanFFTLogAmpValues),
%     IndividualBirds(i).MeanFFTLogAmpValues = MeanFFTLogAmpValues(i).MeanFFTLogAmpValues;
% end
...
switch (BirdOption)
    case 'INNum_MotifNumDur'
        Harini_FeatureFits_INNum_MotifNumDur(DirBout_Stats(BirdsToUse), DirUndirBout_Stats(BirdsToUse), UndirBout_Stats(BirdsToUse), Distances, BirdNames(BirdsToUse));
    case 'Amplitude'
        %Harini_PlotAverageSyllableAmplitudes(IndividualBirds(BirdsToUse), BirdNames(BirdsToUse), DirBout_Stats(BirdsToUse), UndirBout_Stats(BirdsToUse));
    ...
    case 'FF'
        Harini_FeatureFits_FF(DirBout_Stats(BirdsToUse), DirUndirBout_Stats(BirdsToUse), UndirBout_Stats(BirdsToUse), Distances, BirdNames(BirdsToUse));
end
