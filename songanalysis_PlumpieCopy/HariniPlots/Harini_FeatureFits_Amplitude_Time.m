...
for i = 1:length(DirBout_Stats),
    ...
    print(fullfile(FinalFigureDir, [BirdNames{i}, 'Time_FeatureFits_Amplitude.eps']), '-depsc2', '-r600');
    print(fullfile(FinalFigureDir, [BirdNames{i}, 'Time_FeatureFits_Amplitude.png']), '-dpng', '-r600');
end
...
BirdFinalIndices = [10 11 12 13 14 5];
...
set(gcf, 'PaperPositionMode', 'auto');
print(fullfile(FinalFigureDir, ['Time_HFMicBirds_Example_Summary_Amplitude.eps']), '-depsc2', '-r600');
print(fullfile(FinalFigureDir, ['Time_HFMicBirds_Example_Summary_Amplitude.png']), '-dpng', '-r600');
...
set(gcf, 'PaperPositionMode', 'auto');
print(fullfile(FinalFigureDir, ['Time_HFMicBirds_SyllableWise_Summary_Amplitude.eps']), '-depsc2', '-r600');
print(fullfile(FinalFigureDir, ['Time_HFMicBirds_SyllableWise_Summary_Amplitude.png']), '-dpng', '-r600');
