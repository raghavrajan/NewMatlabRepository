function [Bout_Stats] = Harini_CalculateBoutINMotifNumbers_Duration_AmpAdjusted(IndividualBirds, Bouts, MotifLabels, INLabels, CommonMotifs)
...
%    BoutSAPLogAmp = IndividualBirds.AdjustedSyllLogAmplitudeMeanValue(IndividualBirds.Bouts(k,1):IndividualBirds.Bouts(k,2));
