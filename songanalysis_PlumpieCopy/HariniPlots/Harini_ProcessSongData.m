function [BirdParameters, Flag] = Harini_ProcessSongData(BirdDetailsTextFile, InterboutInterval)
...
for i = 1:length(BirdParameters),
    FileNames_FileName = [BirdParameters(i).BirdName, '.', BirdParameters(i).UndirSongFileList, '.', BirdParameters(i).Condition, '.', BirdParameters(i).Microphone, '.FileNames.mat'];
...
for i = 1:length(BirdParameters),
    Notes_FileName = [BirdParameters(i).BirdName, '.', BirdParameters(i).UndirSongFileList, '.', BirdParameters(i).Condition, '.', BirdParameters(i).Microphone, '.Notes.mat'];
...
% for i = 1:length(BirdParameters),
%     TemplateMatchValues_FileName = [BirdParameters(i).BirdName, '.', BirdParameters(i).UndirSongFileList, '.', BirdParameters(i).Condition, '.', BirdParameters(i).Microphone, '.TemplateMatchValues.mat'];
...
for i = 1:length(BirdParameters),
    AronovFeeLogAmpValues_FileName = [BirdParameters(i).BirdName, '.', BirdParameters(i).UndirSongFileList, '.', BirdParameters(i).Condition, '.', BirdParameters(i).Microphone, '.AronovFeeLogAmpValues.mat'];
...
for i = 1:length(BirdParameters),
    ...
    FFTLogAmpValues_FileName = [BirdParameters(i).BirdName, '.', BirdParameters(i).UndirSongFileList, '.', BirdParameters(i).Condition, '.', BirdParameters(i).Microphone, '.FFTLogAmpValues.mat'];
...
for i = 1:length(BirdParameters),
    SyllableInfo_FileName = [BirdParameters(i).BirdName, '.', BirdParameters(i).UndirSongFileList, '.', BirdParameters(i).Condition, '.', BirdParameters(i).Microphone, '.SyllableInfo.mat'];
...
for i = 1:length(BirdParameters),
    ...
    SAPFileName = [BirdParameters(i).BirdName, '.', BirdParameters(i).UndirSongFileList, '.', BirdParameters(i).Condition, '.', BirdParameters(i).Microphone, '.SAPFeats.mat'];
...
for i = 1:length(BirdParameters),
    ...
    SAPFileName = [BirdParameters(i).BirdName, '.', BirdParameters(i).UndirSongFileList, '.', BirdParameters(i).Condition, '.', BirdParameters(i).Microphone, '.AmplitudeRMS.mat'];
    if (exist(SAPFileName, 'file'))
        load(SAPFileName);
...
for i = 1:length(BirdParameters),
    ...
    SAPFileName = [BirdParameters(i).BirdName, '.', BirdParameters(i).UndirSongFileList, '.', BirdParameters(i).Condition, '.', BirdParameters(i).Microphone, '.AmplitudeKao.mat'];
    if (exist(SAPFileName, 'file'))
        load(SAPFileName);
...
for i = 1:length(BirdParameters),
    ...
    SAPFileName = [BirdParameters(i).BirdName, '.', BirdParameters(i).UndirSongFileList, '.', BirdParameters(i).Condition, '.', BirdParameters(i).Microphone, '.FFAutocorrKao.mat'];
    if (exist(SAPFileName, 'file'))
        load(SAPFileName);
...
for i = 1:length(BirdParameters),
    fprintf('%d >> ', i);
    BoutInfo_FileName = [BirdParameters(i).BirdName, '.', BirdParameters(i).UndirSongFileList, '.', BirdParameters(i).Condition, '.', BirdParameters(i).Microphone, '.', num2str(BirdParameters(i).Interboutinterval), '.BoutInfo.mat'];
...
for i = 1:length(BirdParameters),
    fprintf('%d >> ', i);
    Fid = fopen([BirdParameters(i).BirdName, '.', BirdParameters(i).UndirSongFileList, '.', BirdParameters(i).Condition, '.', BirdParameters(i).Microphone, '.BoutInfo.txt'], 'w');
