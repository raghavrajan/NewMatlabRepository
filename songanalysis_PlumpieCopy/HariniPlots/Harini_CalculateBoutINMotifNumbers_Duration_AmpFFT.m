function [Bout_Stats] = Harini_CalculateBoutINMotifNumbers_Duration_AmpFFT(IndividualBirds, Bouts, MotifLabels, INLabels, CommonMotifs)
...
for k = Bouts(:)',
    ...
    BoutSAPLogAmp = IndividualBirds.MeanFFTLogAmpValues(IndividualBirds.Bouts(k,1):IndividualBirds.Bouts(k,2));
