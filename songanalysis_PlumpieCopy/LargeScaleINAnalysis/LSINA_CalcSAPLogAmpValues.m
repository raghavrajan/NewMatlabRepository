function [SAPLogAmplitudes, BaselineAmpValue, SyllableStatus, Amp_Fs] = LSINA_CalcSAPLogAmpValues(BirdParameters)
...
if (BirdParameters.Continuousdata == 0)
    for i = 1:length(BirdParameters.SongFileNames),
        ...
        LogAmplitude = deriv_OnlyLogAmp(RawData, Fs, WindowSize);
        ...
        for j = 1:length(BirdParameters.NoteInfo{i}.onsets),
            ...
            SAPLogAmplitudes{i}{j} = (LogAmplitude(SyllableOnsetTimeIndex:SyllableOffsetTimeIndex));
