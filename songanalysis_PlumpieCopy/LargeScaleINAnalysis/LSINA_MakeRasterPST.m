function [UnDirSpikeTrain, UnDirIFR, UnDirPST, UnDirRaster, DirSpikeTrain, DirIFR, DirPST, DirRaster] = LSINA_MakeRasterPST(SURecordingDetails, NeuronIndex, InterboutInterval, PSTEdges, IFRTime, GaussWin)

SongBouts_WithPreData = find((SURecordingDetails(NeuronIndex).Bouts(:,7) == 1) & (SURecordingDetails(NeuronIndex).Bouts(:,8) >= 0));
