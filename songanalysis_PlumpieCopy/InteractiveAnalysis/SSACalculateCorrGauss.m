function [Corr] = SSACalculateCorrGauss(SpikeTrain, MedianMotif, Width, PreSongStartDuration, PreSongEndDuration, ContextString, GaussianLen)
...
disp([ContextString, ': Gaussian Width = ', num2str(Width * 1000),' ms and correlation = ',num2str(Corr(1)), ' +/- ', num2str(Corr(2))]);
Corr = [Width Corr];