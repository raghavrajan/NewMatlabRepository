function [] = FullIntroNoteAnalysisMultiUnit(DataDir, RecFileDir, NoteFiles, NoteFileDir, FileType, ContinuousOrNot, varargin)
...
save([NoteFiles(1).name, '.INoteAnalysisResults.mat']);
