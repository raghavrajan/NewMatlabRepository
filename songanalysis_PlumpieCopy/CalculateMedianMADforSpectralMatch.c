 /* Calculating the median and median absolute deviation for template match
 * MEX file
 * 
 * Raghav 2009e
 * 
 * inputs: Data      :   This is a vector of the data which has to be windowed and median and mad for each window has to be calculated
