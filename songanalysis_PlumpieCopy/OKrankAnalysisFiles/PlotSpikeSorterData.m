function [FiringRate] = PlotSpikeSorterData(DirectoryName, FileName, SpikeFile, ChannelNo, ClusterNos, MaxClusters, FileType, varargin)
...
if ~isempty(strfind(FileType, 'okrank'))
    ...
    if (~isempty(strfind(FileType, 'obs')))
