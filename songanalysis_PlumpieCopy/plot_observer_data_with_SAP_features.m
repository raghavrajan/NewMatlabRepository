...
% Convert to V - 1V on the data acquisition is 32768
rawsong = rawsong * 1/32768;

PlotFigure = figure;
set(gcf,'Color','w');

SongAmplitudePlot = axes('position',[0.15 0.1 0.8 0.3]);
...
SongAmplitudePlot = axes('position',[0.15 0. 0.8 0.25]);
% Plot song spectrogram
SongSpectrogramPlot = axes('position',[0.15 0.425 0.8 0.25]);
