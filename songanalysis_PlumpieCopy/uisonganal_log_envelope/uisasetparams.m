...
% --- Executes on button press in SASetMiscDoPatchCkb.
function SASetMiscDoPatchCkb_Callback(hObject, eventdata, handles)
% hObject    handle to SASetMiscDoPatchCkb (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of SASetMiscDoPatchCkb
