...
while 1
  ...
  % Now calculate log envelope of spectrogram frequencies between 860Hz
  % and 7600Hz

  [S, F, ST, P] = spectrogram(filtsong, 512, 256, 512, Fs);
  P = P(find((F >= 860) & (F <= 7600)),:);
  smooth = 10*log10(sum(P));
  Fs = 1/(ST(2) - ST(1));
  clear S F ST P
