function plotFF_localvar3 (note, birdname);
...
suptitle([birdname, ',  ', FF_time_matfile, '  (red: dir;  blue: undir)'])

%plot the normalized values
plot_notes4DS_UDS(' ', ' ', localcv_dir); hold on
plot_notes2(' ',' ', localcv_undir); axis auto;
suptitle(['% difference from local mean,  ', FF_time_matfile,'  Red: dir,  Blue: undir'])
...
% save the figure
fig_name =  ['FF_',note,'_localvar3.fig']
saveas(gcf,fig_name)

% save the FF difference
saved_file_name = ['FF_', note, '_localvar3']
