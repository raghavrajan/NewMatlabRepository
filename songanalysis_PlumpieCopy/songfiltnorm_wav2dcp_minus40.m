...
% This converts a wav file into a dcp file and attenuates the amplitude (-40dB)
...
while 1
  ...
  % Write to file
  if songtype == 2
    normdcpsongfile = [songfile, '-40dB.norm_40k.dcp']
  else
    normdcpsongfile = [songfile, '-40dB.norm.dcp']
  end
