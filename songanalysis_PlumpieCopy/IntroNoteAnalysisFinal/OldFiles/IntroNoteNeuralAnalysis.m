function [IntroNoteResults] = IntroNoteNeuralAnalysis(DataDir, RecFileDir, SongFileList, NoteFileDir, FileType, MotifSylls, InterBoutInterval, StartSylls, SpikeFileDir, SpikeChanNo, SpikeClusters, ContinuousOrDiscrete, ContinuousFileTime, varargin)

% Get bout details with a function ScreenBouts %
if (nargin > 13)
    ContinuousFiles = varargin{1};
    [BoutDetails, AllBoutDetails] = ScreenBouts_NeuralActivity(DataDir, RecFileDir, FileType, NoteFileDir, SongFileList, InterBoutInterval, MotifSylls, SpikeFileDir, SpikeChanNo, SpikeClusters, ContinuousOrDiscrete, ContinuousFileTime, ContinuousFiles);
else
    [BoutDetails, AllBoutDetails] = ScreenBouts_NeuralActivity(DataDir, RecFileDir, FileType, NoteFileDir, SongFileList, InterBoutInterval, MotifSylls, SpikeFileDir, SpikeChanNo, SpikeClusters, ContinuousOrDiscrete, ContinuousFileTime);
end
