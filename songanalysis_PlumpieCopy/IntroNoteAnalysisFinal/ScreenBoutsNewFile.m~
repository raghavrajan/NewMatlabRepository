function [BoutDetails, AllBoutDetails] = ScreenBoutsNewFile(RawDataDir, RecFileDir, FileType, NoteFileDir, SongFileList, InterBoutInterval, MotifSylls, ContinuousOrDiscrete, varargin)
