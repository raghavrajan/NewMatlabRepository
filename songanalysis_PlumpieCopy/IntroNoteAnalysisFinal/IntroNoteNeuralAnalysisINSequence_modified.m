function [INNeuralAnalysisResults] = IntroNoteNeuralAnalysisINSequence_modified(Neural_INR, PlotOption, MinTrialNumber, PlotPSTH, varargin)
...
%                 end
    ...
    for i = 1:length(FRAxis),
        if (FRAxis(i) > 0)
            axes(FRAxis(i));
            axis(FinalFRAxis);
            %set(gca, 'YTick', [0:50:FinalFRAxis(end)]);
