function [LogAmplitude] = CalcFeats_AmplitudeKao(BirdParameters)
...
for i = 1:length(UniqueFileIndices),
    ...
    for j = 1:length(SyllOnsetTimes),
        ...
        [TempLogAmplitude] = ASSLCalculateLogAmplitudeKaoWithOnsets(SongForSAPCalculations, TimeForSAPCalculations, Fs, SyllOnsetTimes(j)/1000, SyllOffsetTimes(j)/1000);
        LogAmplitude = [LogAmplitude; TempLogAmplitude];
    end
