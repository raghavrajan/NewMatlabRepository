function varargout = paramcb(action,varargin)
...
switch action
  ...
  case 'initcontrols'
    ...
    paramcb('general_params','init', fig);
    paramcb('segment_params','init', fig);
    paramcb('filter_params','init', fig);
    paramcb('specgram_params','init', fig);
    paramcb('print_params','init', fig);
    paramcb('misc_params','init', fig);

  case 'get_params'
    fig = varargin{1};
    % Update all appdata to current settings in dialog
    paramcb('general_params','get', fig);
    paramcb('segment_params','get', fig);
    paramcb('filter_params','get', fig);
    paramcb('specgram_params','get', fig);
    paramcb('print_params','get', fig);
    paramcb('misc_params','get', fig);
  ...
  case 'specgram_params'
	...
	setappdata(SASet.handles.SASet,'SASet_Data',SASet);
	paramcb('specgram_cmap','set',fig);
	paramcb('specgram_gamma_style','set',fig);
  ...
  case 'misc_params'
	...
	SASet.Misc.do_patch = SASet.params.do_patch;	
	...
	set(SASet.handles.SASetMiscDoPatchCkb,'Value',SASet.Misc.do_patch);

	setappdata(SASet.handles.SASet,'SASet_Data',SASet);
	paramcb('do_zc', 'set', fig);
	...
	SASet.Misc.do_patch = get(SASet.handles.SASetMiscDoPatchCkb,'Value');
	% The 'get' method updates the appdata.
	setappdata(SASet.handles.SASet,'SASet_Data',SASet);
      end
    end
  ...
  case 'reset_tabdlg'
    ...
    % DialogUserData.callback = 'paramcb';
