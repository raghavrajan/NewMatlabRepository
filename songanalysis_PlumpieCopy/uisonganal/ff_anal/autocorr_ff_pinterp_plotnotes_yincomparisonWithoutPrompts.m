function [ffreq, RawFF] = autocorr_ff_pinterp_plotnotes_yincomparisonWithoutPrompts(RawDataDir, batch_in,note, ff_low, ff_hi,FileType, PlotOption, FFMeasureDur, InputPercentFromStart) % feature added by Raghav as an argument
...
elseif syl_segment==1
    ...
    percent_from_start = InputPercentFromStart;
