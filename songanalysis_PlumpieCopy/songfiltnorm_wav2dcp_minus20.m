...
% This converts a wav file into a dcp file and attenuates the amplitude (-20dB)
...
while 1
  ...
  % Write to file
  if songtype == 2
    normdcpsongfile = [songfile, '-20dB.norm_40k.dcp']
  else
    normdcpsongfile = [songfile, '-20dB.norm.dcp']
  end
