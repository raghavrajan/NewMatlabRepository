function [] = PlotSpectrogramInAxis_SongVar_ColorMap(SongVar, Time, Fs, Axes, ColourMapValues)
...
noverlap = round(0.8*length(spect_win)); %number of overlapping points       
...
axes(Axes);
hold off;
cm = disp_idx_spect(idx_spect, Time_spect, freq_spect, -80, ...
        -45, 1.2, ColourMapValues, 'classic');
