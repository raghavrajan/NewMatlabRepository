function  [Spectrogram] = PlotMotifSpectrogram(DirectoryName,MedianMotif,MainFigure,SpectrogramPlot, FileType)
...
if (strfind(FileType, 'obs'))
    ...
    cd(DirectoryName);
    [RawSong,Fs] = read_okrank_data([MedianMotif.FileName{1}],'0');
    cd(PresentDirectory);
end
