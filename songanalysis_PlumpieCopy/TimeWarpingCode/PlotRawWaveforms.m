...
if (length(DirFileInfo.RecordLengths) > 0)
    ...
    for i = 1:NoofSongs,
        ...
        SpikeIndices = find((DirFileInfo.SpikeData.Times > (DirFileInfo.Syllables.Start(i,1))) & (DirFileInfo.SpikeData.Times < (DirFileInfo.Syllables.End(i,end))));
...
if (length(UnDirFileInfo.RecordLengths) > 0)
    for i = 1:3,
        ...
        SpikeIndices = find((UnDirFileInfo.SpikeData.Times > (UnDirFileInfo.Syllables.Start(i,1))) & (UnDirFileInfo.SpikeData.Times < (UnDirFileInfo.Syllables.End(i,end))));
